...
#define GC032A_OUTPUT_MODE_PACKET_SDR_4BIT
//#define GC032A_OUTPUT_MODE_PACKET_DDR_2BIT
//#define GC032A_OUTPUT_MODE_PACKET_DDR_4BIT
//#define GC032A_OUTPUT_MODE_DVP_8BIT
...
__align (4) const SENSOR_REG_T GC032A_YUV_640X480[] = {
...
#if defined(GC032A_OUTPUT_MODE_PACKET_SDR_4BIT) //mclk=24mhz,fps=16
	/*System*/
	{0xf3, 0x8f},
	{0xf5, 0x08},
	{0xf7, 0x03},
	...
	{0x3c, 0x30},
	{0xfe, 0x00},
#elif defined(GC032A_OUTPUT_MODE_PACKET_DDR_4BIT)
	/*System*/
...
#elif defined(GC032A_OUTPUT_MODE_DVP_8BIT)
	/*System*/
	{0xf3, 0xff},
	{0xf5, 0x06},
	{0xf7, 0x01},
	...
	{0x3c, 0x30},
	{0xfe, 0x00},
	#else  //(GC032A_OUTPUT_MODE_CCIR656_2BIT)
...
#elif defined(GC032A_OUTPUT_MODE_PACKET_SDR_4BIT)
	{ADDR_AND_LEN_OF_ARRAY (GC032A_YUV_640X480), 640, 480, 24,SENSOR_IMAGE_FORMAT_YUV422},
	// YUV422 PREVIEW 1
	{PNULL, 0, 640, 480, 24, SENSOR_IMAGE_FORMAT_YUV422},
	{PNULL, 0, 0, 0, 0, 0},
...
LOCAL uint32 Set_GC032A_Anti_Flicker (uint32 mode)
{
	...
	case DCAMERA_FLICKER_50HZ:
		...
		GC032A_WriteReg (0x2e, 0xf0); //8.33fps
	...
	case DCAMERA_FLICKER_60HZ:
		...
		GC032A_WriteReg (0x2d, 0x03); //8.56fps
		GC032A_WriteReg (0x2e, 0xd4);
...
LOCAL uint32 Load_GC032A_RegTab_From_T_Flash(void)
{
	...
	SCI_MEM16CPY(unicode_file_name,L"E:\\GC032A_SERIAL_Initialize_Setting.Bin",
				sizeof(L"E:\\GC032A_SERIAL_Initialize_Setting.Bin"));
